...
struct EnergySelectionView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 35) {
                EnergyButton(level: .high, sub: "Feeling great and ready to focus", img: "AniseHigh", selected: $selectionVM.selectedLevel)
                EnergyButton(level: .medium, sub: "Steady but not at full capacity", img: "AniseMedium", selected: $selectionVM.selectedLevel)
                EnergyButton(level: .low, sub: "Tired and needing gentleness", img: "AniseLow", selected: $selectionVM.selectedLevel)
            }
